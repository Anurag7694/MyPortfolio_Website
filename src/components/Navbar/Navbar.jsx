    ...
    <nav className={`fixed top-0 w-full z-50 transition duration-300 px-[7vw] md:px-[7vw] lg:px-[20vw] ${isScrolled ? "bg-[#050414] bg-opacity-50 backdrop-blur-md shadow-md" : "bg-transparent"}`}>
      <div className='text-white py-5 flex justify-between items-center'>
        ...
        <div className='hidden md:flex space-x-4'>
          <a
            href='https://github.com/Anurag7694'
            target="_blank"
          ...
          <a
            href='https://www.linkedin.com/in/anurag-shukla-0081a5290/'
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-300 hover:text-[#8245ec]">
            <FaLinkedin size={24} />
      ...
      {/*Mobile items   */}
      {isOpen && (
        <div className='absolute top-16 left-1/2 transform -translate-x-1/2 w-4/5 bg-[#424254] bg-opacity-50 backdrop-filter backdrop-blur-lg z-50 rounded-lg shadow-lg'>
