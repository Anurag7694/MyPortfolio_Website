    ...
    >
      <div className='flex flex-col-reverse md:flex-row justify-between items-center'>
        ...
        <div className='md:w-1/2 text-center md:text-left mt-8 md:mt-0'>
          ...
          {/* Skills heading with typing affect */}
          ...
          <p className="text-base sm:text-lg md:text-lg text-gray-400 mb-10 mt-8 leading-relaxed">
            ...
            I enjoy learning new technologies and improving my design and development skills.
          </p>
          {/* Resume Button */}
          <a
            href="https://drive.google.com/file/d/1Y2Qf-6K3LUKEomwuG1MttpH1sv03PwmH/view?usp=drive_link"
            target="_blank"
